    ...
    return (
        <>
            ...
            <header className="p-4 bg-gray-100 text-gray-800">
                <div className="container flex flex-col md:flex-row text-center space-y-2 md:space-y-0 justify-between h-16 mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="flex space-x-2 flex-row md:items-center md:space-x-4 mx-auto">
                        ...
                        <button type="submit" className="px-6 py-2 font-semibold rounded lg:block bg-green-600 text-gray-50">Add Todo</button>
                    </form>
                </div>
            </header>
            <div className="conatiner p-2 mx-auto sm:p-4 text-gray-800">
                ...
                <div className="relative">
                            <input required value="" type="text" name="Search" placeholder=" searchTodo...." className="w-48 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-100 text-gray-800 border border-gray-300 focus:bg-gray-50" />
                        </div>
                        ...
                        <tbody>
                            {
                                todos.map(todo => (
                                    <tr key={todo._id} className="border-b border-opacity-20 border-gray-300 bg-gray-50">
                                        ...
                                        <td className="p-3 ">
                                            <button onClick={() => handleTaskClick(todo._id)} className="px-3 py-1 font-semibold rounded-md bg-green-600 text-gray-50">
                                                <span>Tasks: {todo.tasks.length}</span>
                                            </button>
                                        </td>
                                        <td className="p-3">
                                            <button onClick={() => handleDelete(todo._id)} className="px-3 py-1 font-semibold rounded-md bg-red-600 text-gray-50">
                                                <span> <MdDelete/></span>
                                            </button>
                                        </td>
                                        <td className="p-3 ">
                    ...
                    <header className="p-4 bg-gray-100 text-gray-800">
                        <div className="container flex justify-between h-16 mx-auto">
                            <form onSubmit={addTask} className="flex items-center md:space-x-4 mx-auto">
                                ...
                                <button type="submit" className="hidden px-6 py-2 font-semibold rounded lg:block bg-green-600 text-gray-50">Add Task</button>
                            </form>
                        </div>
                    </header>
                    <div className="overflow-x-auto shadow-md">
                                ...
                                <tbody>
                                    {
                                        tasks.map(task => (
                                            <tr tr key={todo._id} className="border-b border-opacity-20 border-gray-300 bg-gray-50" >
                                                ...
                                                <td className="p-3">
                                                    <button onClick={(e) => handleTaskDelete(e)} className="px-3 py-1 font-semibold rounded-md bg-red-600 text-gray-50">
                                                    <MdDelete/>
                                                    </button>
                                                </td>
                                            </tr>
